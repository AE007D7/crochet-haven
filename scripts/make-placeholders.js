...
const items = [
  ...
  { file: "placeholder-mummy.svg", bg: "#e9e2d0", accent: "#3d2b1f", label: "Amigurumi Mummy" },
  { file: "placeholder-skeleton.svg", bg: "#e6ded2", accent: "#3d2b1f", label: "Amigurumi Skeleton" },
  { file: "placeholder-bat-ornament.svg", bg: "#e6ded2", accent: "#3d2b1f", label: "Bat Ornament" },
  { file: "placeholder-spider.svg", bg: "#ece3d2", accent: "#3d2b1f", label: "Amigurumi Spider" },
  { file: "placeholder-jack-o-lantern-basket.svg", bg: "#f3e2d3", accent: "#c1694f", label: "Jack-O-Lantern Basket" },
  { file: "placeholder-witch-broom.svg", bg: "#e9e2d0", accent: "#8a7458", label: "Witch Broom" },
  { file: "placeholder-candy-corn.svg", bg: "#f6e9d3", accent: "#c1694f", label: "Candy Corn" },
  { file: "placeholder-trick-or-treat-bag.svg", bg: "#e6ded2", accent: "#3d2b1f", label: "Trick-or-Treat Bag" },
  { file: "placeholder-green-monster.svg", bg: "#e3ead8", accent: "#7c8c6e", label: "Green Monster" },
  { file: "placeholder-halloween-bib.svg", bg: "#f3e2d3", accent: "#c1694f", label: "Halloween Baby Bib" },
  { file: "placeholder-baby-beanie.svg", bg: "#f0e3e6", accent: "#c1694f", label: "Baby Beanie" },
  { file: "placeholder-baby-booties.svg", bg: "#eef1ee", accent: "#7c8c6e", label: "Baby Booties" },
  { file: "placeholder-baby-romper.svg", bg: "#f0e3e6", accent: "#c1694f", label: "Baby Romper" },
  { file: "placeholder-baby-swaddle.svg", bg: "#eef1ee", accent: "#7c8c6e", label: "Baby Swaddle Blanket" },
  { file: "placeholder-mothers-beret.svg", bg: "#e9e2d0", accent: "#8a7458", label: "Mother's Slouchy Beret" },
